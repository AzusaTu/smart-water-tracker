...
void test_refill_event_recording_and_boot_session_id() {
    ...
    BleWaterService service2("water_c3_a1b2"); // Simulated reboot (new session)
...
void setup() {
    ...
    RUN_TEST(test_refill_event_recording_and_boot_session_id);
    UNITY_END();
}
