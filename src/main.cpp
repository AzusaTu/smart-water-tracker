...
void setup() {
    ...
    bleWaterService.begin(cloudSync.getDeviceId(), &scale, &tracker);
    bleWaterService.updateSummary(tracker.getTodayTotalMl(), tracker.getDailyGoalMl(), scale.getFilteredWeight(), scale.isStable());
